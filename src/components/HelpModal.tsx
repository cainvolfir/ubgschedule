...
export default function HelpModal({ onClose }: HelpModalProps) {
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        {/* Modal Header */}
        <div className="bg-tertiary rounded-none border-b-2 border-black p-4 flex justify-between items-center text-white">
          <h2 className="font-extrabold text-xl uppercase flex items-center gap-2">
            <Question weight="bold" className="text-2xl" />
            Pusat Bantuan
          </h2>
          <button onClick={onClose} className="bg-black text-white hover:bg-white hover:text-black border-2 border-black rounded-none p-1 transition-colors">
